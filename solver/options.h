...
#define OPTSTEMPLATE \
  ...
  OPT (inject,8,0,INT_MAX,"additive weighting: if a transfer amount w is 0<=w<=N, inject N onto the sink (source still loses only w), raising total weight; cures the floor-drained livelock (0=off, conservative transfer)"); \
